...
/**
 * The WhatsApp mark, as its own single path.
 *
 * From simple-icons (CC0-1.0). It is a brand glyph rather than a stroked
 * outline like the icons above, so it is filled rather than stroked — matching
 * the others' line weight would leave the speech bubble unreadably thin.
 */
