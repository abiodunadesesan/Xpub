...
export const en: Dictionary = {
  ...
  gallery: {
    ...
    titleTop: "The",
    titleBottom: "Gallery",
    summary: "{moments} moments · {clips} clips · tap to open",
    open: "Open",
    view: "View",
  },
  music: {
    ...
    corner: {
      ...
      bundled:
        "Bundled with the site, so it plays from the venue's own audio.",
      spotifyOnly: "Not bundled with the site yet — play it from the house playlist below.",
